...
import Foundation
    ...
    struct Constants {
        ...
        static let elevenLabsEndpoint = "https://api.elevenlabs.io/v1/text-to-speech"
        static let googleDirectionsEndpoint = "https://maps.googleapis.com/maps/api/directions/json"  // NEW
